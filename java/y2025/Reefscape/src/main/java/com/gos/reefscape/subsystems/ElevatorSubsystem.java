...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    public ElevatorSubsystem() {
        ...
        m_elevatorMotor = new SparkFlex(Constants.SUPERSTRUCTURE_BUS_ID, Constants.ELEVATOR_MOTOR_ID, MotorType.kBrushless);
        m_followMotor = new SparkFlex(Constants.SUPERSTRUCTURE_BUS_ID, Constants.ELEVATOR_FOLLOW_MOTOR_ID, MotorType.kBrushless);
